...
(function(){
  ...
  // Show locating banner immediately and wait up to 7s before fallback
    ...
    navigator.geolocation.getCurrentPosition((pos)=>{
      ...
      // Mark as ready but keep the locating banner until the 7s fallback fires
      geo = { ready:true, allowed:false, lat:null, lng:null };
      // Do not show fallback yet; timer will handle after 7s
