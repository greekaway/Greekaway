...
CREATE TABLE IF NOT EXISTS ma_transfer_requests (
    ...
    flight_status VARCHAR(30) DEFAULT '',
    flight_airline VARCHAR(100) DEFAULT '',
    flight_origin VARCHAR(200) DEFAULT '',
    flight_eta TIMESTAMPTZ,
    flight_actual_arrival TIMESTAMPTZ,
    flight_gate VARCHAR(20) DEFAULT '',
    flight_terminal VARCHAR(20) DEFAULT '',
